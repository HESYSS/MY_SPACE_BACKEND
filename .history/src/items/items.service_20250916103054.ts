    ...
    return {
      items: items.map((item) => {
        ...
        return {
          id: String(item.id),
          crmId: item.crmId,
          title: getField("title", "titleEn"),
          description: getField("description", "descriptionEn"),
          type: getField("type", "typeEn"),
          deal: getField("deal", "dealEn"),
          category: getField("category", "categoryEn"),
          newbuildingName: getField("newbuildingName", "newbuildingNameEn"),
